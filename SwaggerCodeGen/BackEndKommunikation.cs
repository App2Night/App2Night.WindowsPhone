//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v6.16.6142.26951 (NJsonSchema v5.6.6142.18206) (http://NSwag.org)
// </auto-generated>
//----------------------
...
#pragma warning disable // Disable all warnings
    ...
    [GeneratedCode("NSwag", "6.16.6142.26951")]
    public partial class Client
    {
        ...
        public Task<ObservableCollection<Party>> ApiPartyGetAsync()
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task<ObservableCollection<Party>> ApiPartyGetAsync(CancellationToken cancellationToken)
        {
            ...
            if (status_ == "200")
            {
                var result_ = default(ObservableCollection<Party>);
                try
                {
                    if (responseData_.Length > 0)
                        result_ = JsonConvert.DeserializeObject<ObservableCollection<Party>>(Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));
                    return result_;
                }
...
var status_ = ((int)response_.StatusCode).ToString();
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task<ObservableCollection<string>> ApiUserGetAsync()
{
    return ApiUserGetAsync(CancellationToken.None);
}

/// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
/// <returns>Success</returns>
/// <exception cref="SwaggerException">A server side error occurred.</exception>
public async Task<ObservableCollection<string>> ApiUserGetAsync(CancellationToken cancellationToken)
{
    var url_ = string.Format("{0}/{1}", BaseUrl, "api/User");
...
/// <returns>Success</returns>
/// <exception cref="SwaggerException">A server side error occurred.</exception>
public Task ApiUserPostAsync(Login value)
{
   return ApiUserPostAsync(value, CancellationToken.None);
}

/// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
/// <returns>Success</returns>
/// <exception cref="SwaggerException">A server side error occurred.</exception>
public async Task ApiUserPostAsync(Login value, CancellationToken cancellationToken)
{
   var url_ = string.Format("{0}/{1}", BaseUrl, "api/User");
